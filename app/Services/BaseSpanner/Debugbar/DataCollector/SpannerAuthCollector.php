...
namespace App\Services\BaseSpanner\Debugbar\DataCollector;

use App\Services\BaseSpanner\BaseSpannerHelper;
...
class SpannerAuthCollector extends MultiAuthCollector
{
    ...
    {
        if (is_null($user) || !BaseSpannerHelper::isSpanner($user)) {
