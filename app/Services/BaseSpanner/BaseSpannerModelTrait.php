...
use App\Services\BaseSpanner\Eloquent\Relations\SpannerBelongsTo;
use App\Services\BaseSpanner\Eloquent\Relations\SpannerBelongsToMany;
use App\Services\BaseSpanner\Eloquent\Relations\SpannerHasMany;
use App\Services\BaseSpanner\Eloquent\Relations\SpannerHasOne;
use App\Services\BaseSpanner\Eloquent\Relations\SpannerPivot;
use App\Services\BaseSpanner\Eloquent\SpannerEloquentBuilder;
...
trait BaseSpannerModelTrait
{
     ...
     */
    protected function initializeBaseSpannerModelTrait()
    {
     ...
     */
    public static function bootBaseSpannerModelTrait()
    {
    ...
    public function originalIsEquivalent($key)
    {
        ...
        if ($current === $original) {
            ...
            return (string) $this->castAttribute($key, $current) === (string) $original;
        }
     ...
     * @return SpannerEloquentBuilder|Model|Builder
     */
